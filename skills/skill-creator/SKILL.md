...
â   âââ YAML frontmatter (name, description required)
â   âââ Markdown instructions
âââ Bundled Resources (optional)
    âââ scripts/    - Executable code for deterministic/repetitive tasks
    âââ references/ - Docs loaded into context as needed
...
```
cloud-deploy/
âââ SKILL.md (workflow + selection)
âââ references/
    âââ aws.md
    âââ gcp.md
    âââ azure.md
